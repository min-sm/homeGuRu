<?php include '../../Controller/collaborator/RequestListController.php' ?>
<!DOCTYPE html>
<html lang="en">
...
<body class="bg-primary dark:bg-gray-700 ">
    ...
    <div class="p-4 pt-20 sm:ml-64 ">
        <h1 class="text-center font-bold text-2xl mt-5 mb-12  dark:text-gray-400 tracking-wide ">Collaborator Request List</h1>
        <form class=" relative mb-2 " action="collaborator_request_list.php" method="get">
                    ...
                    <tbody>
                        ...
                        ?>
                                    ...
                                    <td class="px-4 py-4 flex justify-center">
                                        <a href="./collaborator_request_preview.php?id=<?= $request['id'] ?>" class="">
                                            <img class="w-5" src="../resources/img/icon/view-details.png" alt="">
                                        </a>
                                    </td>
                                    <td class="px-4 py-4 text-center">
                                        <a href="#" name="delete" onclick="confirmation( '../../Controller/collaborator/RequestDeleteController.php?id=<?= $request['id'] ?>')" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
