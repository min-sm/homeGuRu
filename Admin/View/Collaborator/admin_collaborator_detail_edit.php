    ...
    <div class="p-4 pt-20 sm:ml-64 flex flex-col items-center">
        ...
        <form class="lg:w-3/5 w-full">
            ...
            <div class=" flex float-right  my-10 ">
                <a href="./admin_collaborator_detail_preview.php" type="submit" class="tracking-wider text-white bg-goldYellow opacity-75 hover:opacity-100
