...
include "../../Controller/Property/CollaboratorPropertyOutOfStockListController.php";
?>
    ...
    <div class="p-4 pt-20 sm:ml-64">
        ...
        <div class="pt-4 pb-8 flex items-center">
            ...
            <div class="lg:space-x-8 space-x-4 lg:text-base text-xs">
                ...
                <label for="outStock" class="text-goldYellow cursor-pointer label "><a href="../Collaborator/detail_preview_outStock.php?id=<?= $_GET['id']; ?>">Out of Stock</a>
                </label>
                <label for="inStock" class="text-gray-500 cursor-pointer label "><a href="../Collaborator/detail_preview_inStock.php?id=<?= $_GET['id']; ?>">In Stock</a></label>
