...
<body>
    ...
    <div class="p-4 pt-20 sm:ml-64">
        <h1 class="text-center font-bold text-2xl mt-5 mb-12">Collaborator List</h1>
        ...
        <div class=" relative mb-2">
            ...
            <div class=" flex mb-3">
                ...
                <button type="submit"
                    ...
                    Search</button>
                <a href="./admin_collaborator_add.php" type="submit"
                    class="absolute right-0 text-black bg-primary border-2 border-darkGreen hover:text-white hover:bg-goldYellow focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-lg text-medium px-8 py-2 text-center  dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                    + Add New</a>
            </div>
