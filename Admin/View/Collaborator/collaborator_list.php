<?php include '../../Controller/Collaborator/CollaboratorListController.php' ?>
<!DOCTYPE html>
<html lang="en">
...
<body class="bg-primary dark:bg-gray-700 ">
    ...
    <div class="p-4 pt-20 sm:ml-64">
        <h1 class="text-center font-bold text-2xl mt-5 mb-12  dark:text-gray-400">Collaborator List</h1>
        <div class=" relative mb-2">
            <!--Start  Search Company Name  -->
            <form class=" flex mb-3" action="collaborator_list.php" method="get">
                ...
                <button type="submit" name="search" class="text-white  bg-darkGreen hover:bg-blue-800  focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-lg text-medium px-8 py-2.5 text-center  dark:bg- dark:hover:bg-green-700 dark:focus:ring-green-800">
                    Search</button>
                <a href="./collaborator_add.php" type="submit" class="absolute right-0 text-black bg-white border-4 border-goldYellow hover:text-white hover:bg-goldYellow focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-lg text-medium px-6 py-2 text-center ">
                    + Add New</a>
            </form>
                    ...
                    <tbody>
                        ...
                        ?>
                                    ...
                                    <td class="px-4 py-4 flex justify-center">
                                        <a href="./collaborator_detail_preview.php?id=<?= $collaborator['collaborator_id'] ?>" class=""></p> <img class="w-5" src="../resources/img/icon/view-details.png" alt=""></a>
                                    </td>

                                    <td class="px-4 py-4 text-center">
                                        <a href="#" name="delete" onclick="confirmation( '../../Controller/Collaborator/CollaboratorListDeleteController.php?id=<?= $collaborator['collaborator_id'] ?>')" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
