...
<body class="bg-primary dark:bg-gray-700 tracking-wider dark:text-gray-200">
    ...
    <div class="p-4 pt-20  sm:ml-64 flex flex-col items-center">
        ...
        <form class="w-1/2" id="cForm" action="../../Controller/Collaborator/CollaboratorAllCreateAccountController.php" method="post" enctype="multipart/form-data">
            ...
            <div class="relative float-right">
                <button name="create_collaborator_account" type="submit" class="  my-20  font-bold text-white bg-darkGreen hover:bg-blue-800 
