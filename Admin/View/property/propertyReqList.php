...
<body class="bg-primary dark:bg-gray-700">
    ...
    <div class="p-4 pt-20 sm:ml-64">
            ...
            <div class="flex s justify-around gap-5  flex-wrap w-full  mb-10 ">
                ...
                ?>
                    <div class="w-full  max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="../Property/req_detail.php?id=<?= $property['id'] ?>">
                        ...
                        <div class="px-5 pb-5">
                            ...
                            <div class="mt-2 flex items-center justify-between">
                                <a href="../Property/req_detail.php?id=<?= $property['id'] ?>" class="mt-2.5 mb-5">
                            ...
                            <div class="flex items-center justify-end">
                                <a href="../Property/req_detail.php?id=<?= $property['id'] ?>" class="text-darkGreen dark:text-green-500 border-2 border-slate-500 bg-transparent font-medium rounded-lg text-sm px-5 py-2 text-center dark:border-slate-50">Details</a>
                            </div>
                        </div>
                    </div>
                <?php }
        ...
        <!-- pagination -->
        <?php include_once "../../Controller/Property/RequestListPaginationController.php";
