                ...
                <div class="w-full grid grid-cols-3 lg:text-base text-sm">
                    ...
                    if ($last == 0) {
                        ...
                        foreach ($chunks as $chunk) {
                            ...
                            for ($i = 0; $i < $first; $i++) {
                                if (isset($chunk[$i])) { ?>
                                    <div><input type="checkbox" id='chbx-<?= $chunk[$i]["id"] ?>' name="p_facilities" value='chbx-<?= $chunk[$i]["facility_type"] ?>'>
                        ...
                        for ($i = 0; $i < $columnCount; $i++) {
                            if (isset($chunk[$i])) { ?>
                                <div>
                                    <input type="checkbox" id='chbx-<?= $chunk[$i]["id"] ?>' name="p_facilities" value='chbx-<?= $chunk[$i]["facility_type"] ?>'>
                                    <label for='chbx-<?= $chunk[$i]["id"] ?>'><?= $chunk[$i]["facility_type"] ?></label><br>
                                </div>
                    <?php }
                        }
