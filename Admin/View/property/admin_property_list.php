...
<body>
            ...
            <div class=" relative h-12 ">
                <div class="absolute right-10">
                    <a href="./property_list.php" class=" text-white bg-goldYellow hover:bg-blue-800  focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-lg text-medium px-8 py-2.5 mr-2 text-center  dark:bg- dark:hover:bg-green-700 dark:focus:ring-green-800">
                        See All </a>
                    <button type="submit" class="text-goldYellow bg-primary border-2 border-goldYellow hover:text-white hover:bg-darkGreen focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-lg text-medium px-8 py-2 text-center  dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                        + Add New</button>
                </div>
    ...
    <!--Start  Property Pending List -->
    <div class="p-4 sm:ml-64">
        <h1 class=" font-bold text-2xl mt-5 ">Property Pending List</h1>

        <div class=" relative ">
            <!--Start  Property  List Button  -->
            <div class=" relative h-12 ">
                <a href="./property_pending_list.php" type="submit" class="absolute right-10 text-white bg-goldYellow hover:bg-blue-800  focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-lg text-medium px-8 py-2 text-center  dark:bg- dark:hover:bg-green-700 dark:focus:ring-green-800">
                    See All </a>
    ...
    <!--End  Property Pending  List -->

    <!--Start  Property Request List -->
    <div class="p-4 sm:ml-64">
        <h1 class=" font-bold text-2xl mt-5 ">Property Request List</h1>

        <div class=" relative mb-5">
            <!--Start  Property  List Button  -->
            <div class=" relative h-12 ">
                <a href="./property_request_list .php" type="submit" class="absolute right-10 text-white bg-goldYellow hover:bg-blue-800  focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-lg text-medium px-8 py-2 text-center  dark:bg- dark:hover:bg-green-700 dark:focus:ring-green-800">
                    See All </a>
            ...
            <!--End  Property Request List Table -->



        </div>
    </div>
    <!--End  Property Request  List -->
