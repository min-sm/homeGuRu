...
<body class="bg-primary dark:bg-gray-700 tracking-wide">
    ...
    <div class="p-4 pt-20 sm:ml-64">
        <!-- add property post -->
        <h1 class="text-center font-bold text-2xl mb-8 text-black dark:text-white">Property Request Form Preview</h1>
        ...
        <div class="flex flex-col lg:flex-row items-center sm:items-start gap-4 text-black dark:text-white overflow-x-auto">
            ...
            <div class="image-label-container">
                <div class="image-container" style="background-image: url('../resources/img/house/entrance-hall.jpg');"></div>
                <p>entrance-hall.jpg</p>
            </div>
            <div class="image-label-container">
                <div class="image-container" style="background-image: url('../resources/img/house/dining-room.jpg');"></div>
                <p>dining-room.jpg</p>
            </div>
            <div class="image-label-container">
                <div class="image-container" style="background-image: url('../resources/img/house/kitchen.jpg');"></div>
                <p>kitchen.jpg</p>
            </div>
            <div class="image-label-container">
                <div class="image-container" style="background-image: url('../resources/img/house/living-room.jpg');"></div>
                <p>living-room.jpg</p>
            </div>
            <div class="image-label-container">
                <div class="image-container" style="background-image: url('../resources/img/house/study-room.jpg');"></div>
                <p>study-room.jpg</p>
            </div>
        </div>
        ...
        <div class="flex items-center justify-center mt-4 flex-col space-y-4">
            ...
            <div class="flex w-80 lg:w-3/4 flex-col">
                <div class="flex items-center justify-between text-black dark:text-white">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex items-center flex-col"><p class="text-sm font-thin">Width</p><p>60'</p></div>
                        <div class="flex items-center flex-col"><p class="text-sm font-thin">Length</p><p>220'</p></div>
            ...
            <div class="w-11/12 lg:w-1/2">
                <hr class="w-full h-1 bg-paleGray my-3">
            </div>
