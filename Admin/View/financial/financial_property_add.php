...
<body class="dark:bg-gray-400">
    ...
    <div class=" flex flex-col items-center p-4 pt-20 sm:ml-64">
        <h1 class="  font-bold text-4xl mt-5 mb-12"> Property Payment</h1>
        <form id="pForm" class="relative" action="../../Controller/Financial/PropertyAddController.php" method="post" enctype="multipart/form-data">
            <div class="grid grid-cols-2 gap-20 ">
                ...
                <div class=" absolute bottom-0 right-0  my-5">
                    ...
                    dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 tracking-wide">
                        Add </button>
                    <a href="./financial_rent_list.php" type="" class=" text-darkGreen border-2 border-green-700 bg-transparent hover:bg-alert hover:text-white
