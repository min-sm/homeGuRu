...
<?php include '../../Controller/financial/FinancialTotalFilterController.php' ?>
...
?>
<?php if (!isset($_SESSION['collaborator_cash_total'])) {
    $_SESSION['collaborator_cash_total'] = '';
}
?>
...
$collaborator_cash_total = array_sum(array_values($CollaboratorCashTotal));
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="dark:bg-gray-400">
    ...
    <div class="pt-20 sm:ml-64">
        ...
        <div class="w-full grid lg:grid-cols-3 grid-cols-1 gap-3 bg-secondary mt-5 p-5 px-20 ">
            ...
            <div class="flex flex-col  ">
                ...
                <div class="grid grid-cols-2 ">
                    ...
                    <p class="right-0 font-semibold text-right text-sm text-goldYellow "><?= number_format($collaborator_cash_total) ?><span class="font-normal text-sm text-gray-200 tracking-wider">Kyats</span></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 pl-1  ">
                ...
                <p class="right-0 font-semibold text-right text-sm text-alert "><?= number_format($rent_cash_total + $sale_cash_total + $collaborator_cash_total) ?><span class="font-normal text-sm text-gray-200 tracking-wider">Kyats</span></p>
            </div>
        ...
        <div class="flex justify-center mt-8 mb-16">
            ...
            <div class="mx-4 ">
                <input id="collaborator-radio" type="radio" value="" name="financial_type" class="hidden  w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    ...
    <div id="collaborator" class=" hidden px-10 mb-20 sm:ml-64 flex flex-col items-center ">
        <!--Start  Financial All Total Section -->
        <div class="py-4">
            <span class="mr-4 font-bold text-xl text-secondary dark:text-white text-right">Collaborator Total :</span>
            <span class=" font-bold text-left text-xl text-alert "><?= number_format($collaborator_cash_total) ?> <span class="font-semibold text-lg text-gray-500 tracking-wider"> Kyats</span></span>
        </div>
        <!--End  Financial All Total Section -->
            ...
            <table class=" w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody class="font-medium tracking-wide">
                    ...
                    if ($totalcollaborator != 0) {
                        $collaboratorstart = 1;
                        foreach ($CollaboratorCashTotal as $durationDate => $total) {
