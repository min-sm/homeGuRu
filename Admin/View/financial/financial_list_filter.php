...
<body class="dark:bg-gray-400">
    ...
    <div class="pt-20 sm:ml-64">
        ...
        <div class="flex flex-col items-center justify-center tracking-wider">
            <h1 class="text-center font-bold text-5xl mt-5 mb-12">Financial List <?= $_SESSION['list_tag_value'] ?> </h1>
        ...
        <div class="w-full grid lg:grid-cols-3 grid-cols-1 gap-3 bg-secondary mt-5 p-5 px-20 ">
            ...
            <div class="flex flex-col  ">
                ...
                <div class="grid grid-cols-2 ">
                    <p class="text-sm text-white ">Collaborator List</p>
                    <p class="right-0 font-semibold text-right text-sm text-goldYellow "><?= $_SESSION['total_collaborator']; ?></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 pl-1  ">
                ...
                <p class="right-0 font-semibold text-right text-sm text-alert "><?= $_SESSION['total_rent'] +  $_SESSION['total_sale'] +  $_SESSION['total_collaborator']; ?></p>
            </div>
        ...
        <div class="flex justify-center mt-8 mb-16">
            ...
            <div class="mx-4 ">
                <?php if ($_SESSION['list_tag_value'] == 3) { ?>
                    <input checked id="collaborator-radio" type="radio" value="3" name="financial_type" class="hidden w-16 h-16 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <?php } else { ?>
                    <input id="collaborator-radio" type="radio" value="3" name="financial_type" class="hidden w-16 h-16 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <?php } ?>
                <label for="collaborator-radio" class="relative px-5 py-2 text-lg text-center  text-white font-medium rounded-lg   bg-darkGreen hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300   tracking-wider">
                    <ion-icon class="text-xl mr-2" name="pricetag"></ion-icon>
                    Collaborator
                </label>
            </div>
    ...
    <div id="collaborator" class="  px-10 pb-16 sm:ml-64 flex flex-col items-center ">
        <!--Start  Financial All Total Section -->
        <div class="py-4">
            <span class="mr-4 font-bold text-xl text-secondary dark:text-white text-right">Collaborator List :</span>
            <span class=" font-bold text-left  text-alert "><?= $_SESSION['total_collaborator']; ?></span>
        </div>
        <!--End  Financial All Total Section -->
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody class="font-medium tracking-wide">
                    <?php
                    if ($totalcollaborator != 0) {
                        $collaboratorstart = 1;
                        foreach ($collaborators as $collaborator) {
                            if ($collaboratorstart % 2 != 0) {
                    ?>
                                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                <?php } else { ?>
                                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-4 flex justify-center">
                                    <a href="./financial_list_collaborator_service_cash_in.php?id=<?= $collaborator["id"] ?>&value=<?= 3 ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                        <img class="w-5" src="../resources/img/icon/view-details.png" alt="">
                                    </a>
                                </td>
                                <td class="px-4 py-4 text-center">
                                    <a href="#" name="delete" onclick="confirmation( '../../Controller/Financial/FinancialListCollaboratorServiceDeleteController.php?id=<?= $collaborator['id'] ?>&value=<?= 3 ?>')" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                        <ion-icon name="trash-bin" class="text-xl font-medium cursor-pointer text-alert"></ion-icon>
                                    </a>
                                </td>
                                </tr>
