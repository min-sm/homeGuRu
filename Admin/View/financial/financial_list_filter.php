    ...
    <div class="pt-20 sm:ml-64">
        ...
        <div class="w-full grid lg:grid-cols-3 grid-cols-1 gap-3 bg-secondary mt-5 p-5 px-20 ">
            ...
            <div class="flex flex-col  ">
                ...
                <div class="grid grid-cols-2 ">
                    ...
                    <p class="right-0 font-semibold text-right text-sm text-goldYellow ">300,000</p>
                </div>
            </div>
        ...
        <div class="flex justify-center mt-8 mb-16">
            ...
            <div class="mx-4 ">
                ...
                <label for="collaborator-radio" class="relative px-5 py-2 text-lg text-center  text-white font-medium rounded-lg   bg-darkGreen hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300   dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 tracking-wider">
                    <ion-icon class="text-xl mr-2" name="pricetag"></ion-icon>
                    Collaborator
                </label>
            </div>
