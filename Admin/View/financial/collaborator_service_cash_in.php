    ...
    <div class="p-4 pt-20 sm:ml-64 flex flex-col items-center">
        <div class=" lg:w-2/5 w-full grid grid-row-9 gap-5">
            ...
            <div class="grid grid-cols-2 gap-7 ">
                ...
                <p name="gc_id" class="font-normal text-sm">GC-1</p>
            </div>
            <div class="grid grid-cols-2 gap-7 ">
                <p class="font-medium text-lg">Company Name</p>
                <p name="gc" class="font-normal text-sm">MAGA Real Estate Co.,Lt</p>
            </div>
            <div class="grid grid-cols-2 gap-7 ">
                <p class="font-medium text-lg">Service Duration</p>
                <p name="sduration_id" class="font-normal text-sm">3 months</p>
            </div>
            <div class="grid grid-cols-2 gap-7 ">
                <p class="font-medium text-lg">Service Package</p>
                <p name="spackage_id" class="font-normal text-sm">Normal</p>
            </div>
         
            <div class="grid grid-cols-2 gap-7 ">
                <p class="font-medium text-lg" > Cash Amount</p>
                <p name="ccash_amount" class="font-normal text-sm">300,000 Kyats</p>
            </div>
            <div class="grid grid-cols-2 gap-7 ">
                <p class="font-medium text-lg" >Payer Name</p>
                <p name="ccash_payer_name" class="font-normal text-sm">John</p>
            </div>
            <div class="grid grid-cols-2 gap-7 ">
                <p class="font-medium text-lg" >Payer Phone</p>
                <p name="ccash_phone" class="font-normal text-sm">(+95) 9876543210</p>
            </div>
            <div class="grid grid-cols-2 gap-7 ">
                <p class="font-medium text-lg" >Recipient Name</p>
                <p name="ccash_recipient_name" class="font-normal text-sm">Mary</p>
            </div>
        ...
        <div class=" flex  my-20 ">
            <a href="./financial_collaborator_edit.php" type="submit"
            ...
            <a href="./financial_collaborator_list.php" type=""
