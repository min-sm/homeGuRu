...
$query = "SELECT * FROM m_users WHERE del_flg = 0 AND gu_verify = 1 ORDER BY id LIMIT $recordsPerPage OFFSET $offset";

$sql = $pdo->prepare($query);
$sql->execute();
$users = $sql->fetchAll(PDO::FETCH_ASSOC);

$queryForResultCount = "SELECT COUNT(id) AS total_result FROM m_users WHERE del_flg = 0 AND gu_verify = 1";
