...
<body class="bg-[#F7F7F7] tracking-wide" style=" background-color: <?= $colors[0]['background'] ?>;color:<?= $colors[0]['bd_text_color'] ?>">
  ...
  <div>
    ...
    <div class="lg:w-2/3 w-full flex flex-col items-center justify-around float-left">
      <div class="w-96 lg:w-[674.86px] lg:h-96 h-56 bg-cover bg-center rounded-lg property-img" style="background-image: url('../../../Storage/house/<?= $property_datas[0]["id"] ?>/<?= $property_datas[0]["p_photo_1"] ?>')"></div>
      ...
      <div class="flex flex-row items-center w-3/4 justify-evenly mt-7">
        ...
        <?php foreach ($photos as $photo) : ?>
          <div class="w-20 lg:w-40 h-12 lg:h-24 bg-cover bg-center rounded-lg property-img" style="background-image:url('../../../Storage/house/<?= $property_datas[0]["id"] ?>/<?= $photo ?>')"></div>
        <?php endforeach; ?>
      </div>
