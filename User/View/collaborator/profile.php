...
<div class="flex justify-center items-center mt-10">
    <div class="flex items-center border-8 p-12 w-11/12 sm:w-3/4 flex-col lg:flex-row p-1">
        <div class="rounded-full  border-gray-400  border-2   border-solid bg-[#D9D9D9] w-40 h-40 overflow-hidden flex-none" id="imgContainer">
    ...
    <div class="flex flex-col items-center justify-center mt-10 ">
        <h1 class="text-2xl font-bold text-center" style="font-family: 'Playfair Display';"> <span><?= $collaborator['gc_company_name']?></span>'s Properties</h1>
        <div class="flex  justify-around   flex-wrap w-full  gap-5 mt-10 mb-10 ">
