...
<body class="bg-[#F7F7F7]">
    ...
    <div class="flex flex-col w-full items-center justify-evenly my-10">
        <h1 class="font-semibold text-3xl text-center " style="font-family: 'Playfair Display';">Collaborator Register
        </h1>
        <form class="w-4/6 mx-auto  my-16"  action="../../Controller/Collaborator_register/CollaboratorRegisterController.php" method="Post"  enctype="multipart/form-data">
...
<input type="file" required name="clogo" id="clogo" class="hidden" onchange="previewFile()">
                ...
                <div class="">
                    <div class="mb-8">
                        <label for="cCompanyName" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">
                            Company Name</label>
                        <input type="text" required name="cCompanyName" id="cCompanyName" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder=" Enter your Company Name">
                    </div>

                    <div class="mb-8">
                        <label for="cCompanyId" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">
                            Company ID</label>
                        <input type="text" required name="cCompanyId" id="cCompanyId" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter your Company Register ID Number">
                    </div>

                    <div class="mb-8">
                        <label for="caddress" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Your
                            Address</label>
                        <textarea name="caddress" required id="caddress" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter your Company Address"></textarea>
