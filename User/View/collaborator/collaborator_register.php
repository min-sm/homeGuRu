...
=======
                    ...
                    <div class="flex items-end m-16">

                        <button type="submit" class="text-white border-2 bg-darkGreen
                      focus:ring-4 focus:outline-none font-semibold rounded-lg text-medium px-8 py-2 text-center 
                      dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                            Submit</button>
                        <button type="" class="mx-16 text-darkGreen border-2 border-darkGreen bg-transparent hover:bg-green-800 hover:text-black
                      focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-lg text-medium  px-7 py-2 text-center 
                      dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Cancle</button>
        ...
        <div class="flex items-center h-5">
            ...
            <label for="terms" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                Already have account?<a href="#" class="text-blue-600 hover:underline dark:text-blue-500">Sign
                    in</a></label>
