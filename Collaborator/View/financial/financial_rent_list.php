...
<?php include '../../Controller/Financial/RentListController.php' ?>
...
<body class="dark:bg-gray-400">
    ...
    <div class="p-4 pt-20 sm:ml-64">
        <h1 class=" font-bold text-4xl mt-5 mb-12">Rent Service Cash In</h1>
        <div class=" relative h-20 mb-2">
            <!--Start  Search Property Code  -->
            <form class=" flex mb-3" action="financial_rent_list.php" method="get">
                ...
                <tbody class="font-medium tracking-wide">
                    ...
                    ?>
                                ...
                                <td class="px-4 py-4 text-center">
                                    <a href="#" name="delete" onclick="confirmation( '../../Controller/Financial/RentServiceDeleteController.php?id=<?= $rent['id'] ?>')" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
