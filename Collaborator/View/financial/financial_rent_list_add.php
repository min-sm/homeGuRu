...
<body class="dark:bg-gray-400">
 ...
 <?php include '../common/menu.php' ?>
    <div class=" flex flex-col items-center p-4 pt-20 sm:ml-64">
        <h1 class="  font-bold text-4xl mt-5 mb-12"> Rent Payment</h1>
        <form id="pForm" class="relative" action="../../Controller/Financial/RentListAddController.php" method="post" enctype="multipart/form-data">
