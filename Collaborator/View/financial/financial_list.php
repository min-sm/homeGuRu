...
<body>
    ...
    <div class="p-4 pt-20 sm:ml-64">
        ...
        <div class="flex flex-col items-center justify-center tracking-wider">
            <h1 class=" font-bold text-3xl mt-5 mb-12">Financial Filter </h1>
            <div class="flex">
                <a href="./financial_list_filter.php" type="submit" class="lg:mr-20 mr-10  text-white bg-darkGreen hover:bg-blue-800 
                    focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xl lg:px-14 px-8 py-2 text-center 
        ...
        <h1 class=" text-center font-bold text-2xl  mt-8 ">Sale Service Cash In</h1>
        ...
        <h1 class=" text-center font-bold text-2xl  mt-10 mb-2">Rent Service Cash In</h1>
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-base text-gray-700 uppercase bg-primary dark:bg-gray-800 dark:text-gray-400">
                    <tr>
