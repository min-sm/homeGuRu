...
<head>
    ...
    <!-- JS -->
    <script src="../resources/js/sort_by_section_(diff).js" defer></script>
...
<body class="bg-primary dark:bg-gray-700">
    ...
    <div class="p-4 pt-20 sm:ml-64">
        <h1 class="text-center font-bold text-2xl mb-8 text-black dark:text-white">Property Rent List</h1>
